...
const ghanaData = {
    ...
    regions: [
        ...
        { name: "Ashanti Region", capital: "Kumasi", districts: ["Adansi North","Adansi South","Adansi Asokwa","Afigya Kwabre North","Afigya Kwabre South","Ahafo Ano North Municipal","Ahafo Ano South East","Ahafo Ano South West Municipal","Akrofuom","Amansie Central","Amansie South","Amansie West","Asante Akim Central Municipal","Asante Akim North","Asante Akim South Municipal","Asokore Mampong Municipal","Asokwa Municipal","Atwima Kwanwoma","Atwima Mponua","Atwima Nwabiagya Municipal","Atwima Nwabiagya North Municipal","Bekwai Municipal","Bosome Freho","Bosomtwe","Ejisu Municipal","Ejura/Sekyedumase Municipal","Juaben Municipal","Kumasi Metropolitan","Kwabre East Municipal","Kwadaso Municipal","Mampong Municipal","Obuasi East Municipal","Obuasi Municipal","Offinso Municipal","Offinso North","Oforikrom Municipal","Old Tafo Municipal","Sekyere Afram Plains","Sekyere Central","Sekyere East","Sekyere Kumawu","Sekyere South","Suame Municipal"] },
        { name: "Bono Region", capital: "Sunyani", districts: ["Banda","Berekum East Municipal","Berekum West","Dormaa Central Municipal","Dormaa East","Dormaa West","Jaman North","Jaman South Municipal","Sunyani Municipal","Sunyani West Municipal","Tain","Wenchi Municipal"] },
        ...
        { name: "Greater Accra Region", capital: "Accra", districts: ["Ablekuma Central Municipal","Ablekuma North Municipal","Ablekuma West Municipal","Accra Metropolitan","Ada East","Ada West","Adenta Municipal","Ashaiman Municipal","Ayawaso Central Municipal","Ayawaso East Municipal","Ayawaso North Municipal","Ayawaso West Municipal","Ga Central Municipal","Ga East Municipal","Ga North Municipal","Ga South Municipal","Ga West Municipal","Korle-Klottey Municipal","Kpone-Katamanso","Krowor Municipal","La-Dade-Kotopon Municipal","La Nkwantanang Madina Municipal","Ledzokuku Municipal","Ningo-Prampram","Okaikwei North Municipal","Shai-Osudoku","Tema Metropolitan","Tema West Municipal","Weija Gbawe Municipal"] },
